...
email_regex = r'\w+@\w+\.(com|org|edu|net)' # replace this with your regex
...
def filter_lines_with_email(list_of_lines):
    ...
    for line in list_of_lines:
        if re.search(email_regex, line): # replace ellipsis with your code
