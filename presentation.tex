...
\begin{frame}{Extracting matches}

Sometimes we don't just want to check if something matches, we want to actually
extract the matching string. The match object allows us access to this via .groups().
