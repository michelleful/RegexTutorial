...
\begin{itemize}
  \item \lstinline$re.match(regex, string)$ -- returns a match group if the string starts with the regex pattern, \lstinline$None$ otherwise.
...
Then access the matched bits via the match object returned by \lstinline$re.match()$ and \lstinline$re.search()$
...
parentheses  \lstinline$(...)$ with  \lstinline$(?:...)$ whenever you
